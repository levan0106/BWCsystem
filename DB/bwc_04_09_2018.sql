...
CREATE TABLE `productprice` (
  ...
  UNIQUE KEY `CreateBy` (`CreateBy`),
  UNIQUE KEY `UpdateBy` (`UpdateBy`)
) ENGINE=InnoDB AUTO_INCREMENT=8115 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `timesheetdetail` (
  ...
  UNIQUE KEY `CreateBy` (`CreateBy`),
  UNIQUE KEY `UpdateBy` (`UpdateBy`)
) ENGINE=InnoDB AUTO_INCREMENT=686 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
