<template>
    <el-row>
        ...
        @click="openModal"
        :disabled="order.Step >= 3">Add Sale Product</el-button>  
...
export default {
    ...
    methods:{
        ...
        getProductStep(id){
			return this.$store.getters['order/productSteps'].filter(item=>item.Value==id)[0].Label
		},
    }
}
</script>
