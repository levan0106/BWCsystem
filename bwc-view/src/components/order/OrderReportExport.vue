<template>
    ...
    <div slot="content">
        <div>
            Customer: <b>{{filterValues.customerName}}</b>
        </div>
        <div>
    ...
    methods:{
        ...
        async generateHtml(){
            ...
            if(totalRow > 0){
                ...
                // creat table header
                var headerNames = ['#','Order Id','Customer','Order Date','Ref/Name','Invoice Date','Invoice','Paid Date','Paid','Balance']
                ...
                for (let row = 0; row <  totalRow; row++) { 
                    ...
                    ccell = rrowTable.insertCell();
                    ccell.innerHTML = this.data[row].CustomerName
                    ccell = rrowTable.insertCell();
