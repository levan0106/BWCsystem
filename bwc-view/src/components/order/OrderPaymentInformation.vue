...
<div id="purchase-process-info">
    ...
    <el-button type="primary" @click="openPaymentModal" :disabled="maxPayAmount <= 0" >
...
export default {
    ...
    computed:{
        ...
        maxPayAmount(){            
            return this.maxValue - this.getSummaries(this.dataPayment,'AmountPaid');
        }
    },
    created(){
