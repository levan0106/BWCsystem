            ...
            <bwc-loading :loading="loading">    
                <el-row :gutter="20">
                    <el-col :span="10">                
                        ...
                        prop="PurchasePrice" :rules="purchaseRule">
                            <bwc-input-currency 
...
export default {
    ...
    computed:{
        ...
        purchaseRule(){
            return [
                {required: this.form.ComponentType == 1, message: 'This is a required field', trigger: 'blur' }
            ]
        },
        saleRule(){
            return [
                {required: this.form.ComponentType == 0, message: 'This is a required field', trigger: 'blur' }
            ]
        }
    },
    created(){
